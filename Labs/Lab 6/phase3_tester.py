import pygame
import math3d      # You'll need your math3d file to run this   # You'll need your math3d file to run this...
...
allShapes.append(math3d.Sphere(math3d.VectorN(200, 200, 0), 50, math3d.VectorN(1, 1, 0)))
allShapes.append(math3d.Plane(math3d.VectorN(0,1,0), 10, math3d.VectorN(0,1,0)))
allShapes.append(math3d.Plane(math3d.VectorN(20,1,0), 60, math3d.VectorN(0,1,1)))
allShapes.append(math3d.Plane(math3d.VectorN(-2, -7, 0), -600, math3d.VectorN(1,0.5,0)))
